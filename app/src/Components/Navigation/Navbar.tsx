...
import * as Instagram from "../../Images/Logos/instagram.png";
...
interface NavGroupProps {direction?: 'row' | 'column', grow?: number, justify?: 'flex-start' | 'flex-end' | 'center' | 'space-between' | 'space-around'};
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <Copyright name={this.context.data.info.name} developer={this.context.data.developer} />
