...
*/
export default class Stickybits {
    version;
    userAgent;
    props;
    els;
    ...
    */
    addInstance = function addInstance(el, props) {
        const item = {
            el,
            parent: el.parentNode,
            props,
            state: 'default',
            stateContainer: () => this.manageState(item)
        }
    ...
    */
    ...
    /*
      ...
      - defines
        ...
        - stop
    */
    computeScrollOffsets = function computeScrollOffsets(item) {
        const it = item
        const p = it.props
...
*/
    ...
    /*
      ...
      - defines the state
        ...
        - stuck
    */
    manageState = function manageState(item) {
        // cache object
        const it = item
        const e = it.el
        const p = it.props
