...
export default class Copyright extends React.Component<CopyrightProps, {}> {
    render() {
        return (
            <Box justify='center' align='center' margin="0">
                <span style={{textAlign: 'center'}}>&copy; 2018 <span style={{ fontWeight: 'bold' }}>{this.props.name}</span> All Rights Reserved.&nbsp;</span>
