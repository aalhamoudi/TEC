...
type Effect = AnimationKeyFrame | AnimationKeyFrame[] | AnimationSequence;
...
export default class Animated extends React.Component<AnimationProps, {visible: boolean}> {
  ...
  onEntering() {
      if (!this.enterAnimation) {
          ...
          this.enterAnimation = new Animation(effect, document.timeline);
      }
  ...
  onExiting() {
      if (!this.exitAnimation) {
          ...
          this.exitAnimation = new Animation(effect, document.timeline);
