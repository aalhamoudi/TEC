...
export default class AboutWidget extends React.Component<AboutWidgetProps, {}> {
    render() {
        return (
            <Box fill="both" justify="space-evenly" align="center" image={this.props.background} direction={screen.width > 768 ? 'row' : 'column'}>
                ...
                <Default>
                    <img src={this.props.image} style={{ width: 150, height: 150, margin: 10, position: 'absolute', top: 50, left: 50 }} />
                </Default>
            </Box>
        );
    }
